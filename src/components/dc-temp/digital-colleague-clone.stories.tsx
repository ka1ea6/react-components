...
const mockDigitalColleagues: DigitalColleague[] = [
  ...
  },
  {
    ...
    knowledge: [
      { id: "kb-1", title: "Product Manual", description: "Complete product documentation", createdAt: new Date() },
      { id: "kb-2", title: "FAQ Database", description: "Common questions and answers", createdAt: new Date() },
    ],
    coreKnowledge: [],
    version: "3.0.0",
...
const meta: Meta<typeof DigitalColleagueClone> = {
  title: "DC/Components/DigitalColleagueClone",
