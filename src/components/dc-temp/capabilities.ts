...
export const defaultColorScheme: CapabilityColorScheme = {
  ...
  categories: ["bg-green-600", "bg-pink-600", "bg-indigo-600", "bg-orange-600"],
  lists: ["bg-blue-500", "bg-orange-500", "bg-purple-500", "bg-green-500"],
  items: ["bg-gray-400", "bg-slate-400", "bg-zinc-400", "bg-neutral-400"]
}
