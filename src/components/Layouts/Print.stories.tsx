...
import { PagePrintable } from './Print';
...
const meta: Meta<typeof PagePrintable> = {
  title: 'Layouts/Print',
  component: PagePrintable,
  parameters: {
    layout: 'fullscreen',
  },
  argTypes: {
...
const Template = (args: any) => <PagePrintable {...args} />
type PageStory = StoryObj<typeof PagePrintable>
