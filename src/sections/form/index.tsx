...
export function Form({ onSubmit }: FormProps = {}) {
  return (
    ...
    >
      {({ errors, touched, values, handleChange, handleBlur, isSubmitting, handleSubmit }) => (
        <form
          onSubmit={handleSubmit}
          className="grid grid-cols-1 gap-2 pt-2 lg:grid-cols-2"
        >
          <div>
            <TextInput
              ...
              className={cn(fieldCommonClasses, errors.name && touched.name && errorClasses)}
            />
